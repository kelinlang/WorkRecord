...
[Android绘制流程窗口启动流程分析](https://www.cnblogs.com/tiger-wang-ms/p/6517048.html)
...
![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="583" height="870"></svg>)
...
![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="864" height="700"></svg>)
...
![在这里插入图片描述](https://user-gold-cdn.xitu.io/2019/7/17/16bff435659fa7f8?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="864" height="97"></svg>)

MeasureSpec有三种测量模式：

![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="864" height="181"></svg>)
...
![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="864" height="585"></svg>)

![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="864" height="422"></svg>)
...
4. 已经知道怎么去摆放还不行啊，决定了怎么摆放就是相当于把已有的空间”分割”成大大小小的空间，每个空间对应一个子View，我们接下来就是把子View对号入座了，把它们放进它们该放的地方去。
   ...
   ![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="864" height="606"></svg>)

   ![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="864" height="379"></svg>)

   

自定义ViewGroup可以参考：[Android自定义ViewGroup](https://blog.csdn.net/ldld1717/article/details/80458917)
...
![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="483" height="639"></svg>)
...
![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="864" height="610"></svg>)
...
![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="808" height="864"></svg>)
...
[www.jianshu.com/nb/12554212](https://www.jianshu.com/nb/12554212)
...
![在这里插入图片描述](https://user-gold-cdn.xitu.io/2019/7/17/16bff435ac77a9fb?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
